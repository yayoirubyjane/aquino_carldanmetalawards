...
@section('content')
    <div class="page-card max-w-3xl">
        <h2 class="mb-6 text-2xl font-bold text-slate-900">Add Client</h2>
        ...
        <form action="{{ route('clients.store') }}" method="POST" class="space-y-5">
            ...
            <div class="grid gap-5 md:grid-cols-3">
                <div>
                    ...
                    <input type="text" name="ClientFN" value="{{ old('ClientFN') }}" class="page-input" required>
                </div>

                <div>
                    <label class="mb-2 block text-sm font-semibold text-slate-700">Middle Name</label>
                    <input type="text" name="ClientMN" value="{{ old('ClientMN') }}" class="page-input">
                </div>

                <div>
                    <label class="mb-2 block text-sm font-semibold text-slate-700">Last Name</label>
                    <input type="text" name="ClientLN" value="{{ old('ClientLN') }}" class="page-input" required>
                </div>
            </div>

            <div>
                <label class="mb-2 block text-sm font-semibold text-slate-700">Contact</label>
                <input type="text" name="ClientContact" value="{{ old('ClientContact') }}" class="page-input" required>
            </div>

            <div class="grid gap-5 md:grid-cols-2">
                <div>
                    <label class="mb-2 block text-sm font-semibold text-slate-700">Street</label>
                    <input type="text" name="ClientStreet" value="{{ old('ClientStreet') }}" class="page-input" required>
                </div>

                <div>
                    <label class="mb-2 block text-sm font-semibold text-slate-700">Barangay</label>
                    <input type="text" name="ClientBarangay" value="{{ old('ClientBarangay') }}" class="page-input">
                </div>
            </div>
            ...
            <div class="grid gap-5 md:grid-cols-2">
                <div>
                    ...
                    <input type="text" name="ClientCity" value="{{ old('ClientCity') }}" class="page-input" required>
                </div>

                <div>
                    <label class="mb-2 block text-sm font-semibold text-slate-700">Province</label>
                    <input type="text" name="ClientProvince" value="{{ old('ClientProvince') }}" class="page-input">
                </div>
            </div>

            <div class="flex gap-3">
                <button type="submit" class="page-button-primary">Save Client</button>
